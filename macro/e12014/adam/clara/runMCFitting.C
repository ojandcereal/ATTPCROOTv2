...
void runFitting()
{
   ...
   TString path = "./";
   TString InputDataFile = path + "/Bi200Chi2.root";
   TString evtInputDataFile = path + "/Bi200Chi2.root";

   TString OutputDataFile = path + "/data/BaselineFit.root";
   ...
   /** Create the simulation to do the fitting on **/
   ...
   fitter->SetChargeObjective(MCFitter::AtMCFission::ObjectiveChargeChi2);
   // fitter->SetAmp(0.454);
